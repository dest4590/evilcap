...
const (
	EnvVarName     = "CAPSPATH"
	Suffix         = ".cap"
	InstallArchive = "https://github.com/dest4590/evilcap/archive/master.zip"
)

func getDefaultInstallBase() string {
	if runtime.GOOS == "windows" {
		return filepath.Join(os.Getenv("ALLUSERSPROFILE"), "evilcap")
	}
	return "/usr/local/share/evilcap/"
}
