...
import (
	...
	"github.com/dest4590/evilcap/v2/caplets"
	"github.com/dest4590/evilcap/v2/core"
	"github.com/dest4590/evilcap/v2/firewall"
	my_log "github.com/dest4590/evilcap/v2/log"
...
const (
	DefaultHistoryFile = "~/evilcap.history"
	HistoryEnvVar      = "EVILCAP_HISTORY"
)
...
const AliasesFile = "~/evilcap.aliases"
